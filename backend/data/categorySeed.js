const CATEGORY_TREE_SEED = [
  {
    ...
    microCategories: [
      ...
      { slug: 'finance-investment', name: 'Finance & Investment', aliases: ['finance', 'investment', 'finance and investment', 'stock market'], starterCount: 1200, spotlight: true, spotlightOrder: 8, iconKey: 'badgeIndianRupee', accentFrom: '#10b981', accentTo: '#22c55e' },
      ...
      { slug: 'education', name: 'Education', aliases: ['study', 'career', 'kids learning'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'graduationCap', accentFrom: '#6366f1', accentTo: '#3b82f6' },
      { slug: 'motivation-self-growth', name: 'Motivation & Self Growth', aliases: ['motivation', 'self growth', 'personal branding'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'rocket', accentFrom: '#f97316', accentTo: '#ef4444' },
      { slug: 'spiritual-astrology', name: 'Spiritual & Astrology', aliases: ['spiritual', 'astrology'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'moonStar', accentFrom: '#8b5cf6', accentTo: '#c084fc' },
      { slug: 'fashion', name: 'Fashion', aliases: ['style'], starterCount: 980, spotlight: true, spotlightOrder: 3, iconKey: 'shirt', accentFrom: '#ec4899', accentTo: '#8b5cf6' },
      { slug: 'comedy-entertainment', name: 'Comedy & Entertainment', aliases: ['comedy', 'entertainment', 'roasting'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'theater', accentFrom: '#fb7185', accentTo: '#f97316' },
      { slug: 'historical', name: 'Historical', aliases: ['history'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'scrollText', accentFrom: '#f59e0b', accentTo: '#b45309' },
      { slug: 'art-craft', name: 'Art & Craft', aliases: ['art', 'craft'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'palette', accentFrom: '#f97316', accentTo: '#eab308' },
      ...
      { slug: 'vlogs', name: 'Vlogs', aliases: ['vlog'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'clapperboard', accentFrom: '#3b82f6', accentTo: '#8b5cf6' },
      { slug: 'street-interviews', name: 'Street Interviews', aliases: ['street interview'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'mic2', accentFrom: '#14b8a6', accentTo: '#0ea5e9' },
      ...
      { slug: 'influencer', name: 'Influencer', aliases: ['creator'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'megaphone', accentFrom: '#8b5cf6', accentTo: '#ec4899' },
      ...
      { slug: 'celebrity', name: 'Celebrity', aliases: ['celeb'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'star', accentFrom: '#f59e0b', accentTo: '#f97316' }
    ]
  },
  {
    slug: 'city-pages',
  ...
  },
  {
    ...
    sortOrder: 4,
    microCategories: [
      { slug: 'all-types', name: 'All Types', aliases: ['all type', 'all'], starterCount: 0, spotlight: false, spotlightOrder: 99, iconKey: 'crown', accentFrom: '#f59e0b', accentTo: '#f97316' }
    ]
  }
];
