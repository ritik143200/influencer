                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative mt-4" ref={microDropdownRef}>
                        ...
                        {isMicroDropdownOpen ? (
                          <div className="absolute left-0 right-0 bottom-[calc(100%+10px)] top-auto z-30 rounded-[1.4rem] border border-[#3E2A55] bg-[#0D0D0D] p-3 shadow-[0_24px_55px_rgba(6,6,6,0.45)]">
