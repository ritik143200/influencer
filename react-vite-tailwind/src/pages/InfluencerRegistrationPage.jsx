          ...
          <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center text-center p-12">
            <div className="mb-8">
              <div className="mb-6 text-center">
                <h1 className="text-5xl font-bold text-orange-500 mb-4 tracking-tight">Indori Influencer</h1>
                <h2 className="text-2xl text-gray-800 font-semibold">
                  Welcome to <span className="text-orange-500">Indori Influencer</span>
                </h2>
              </div>
            ...
            <div className="space-y-6 text-left max-w-sm mx-auto">
              {[
                ...
                <div key={idx} className="flex items-start space-x-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-orange-100 rounded-2xl flex items-center justify-center group-hover:bg-orange-500 group-hover:text-white transition-all duration-300">
          ...
          <div className="w-full lg:w-1/2 max-w-2xl">
            <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-6 sm:p-10 border border-white/20">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600">Join our platform as a talented influencer. Create your profile to showcase your skills and connect with opportunities.</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  {/* Location */}
                  <div className="space-y-2">
                    <label htmlFor="location" className="block text-sm font-semibold text-gray-700 ml-1">Location</label>
                    <div className="relative group">
                      <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-orange-500 transition-colors">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Categories */}
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-700 ml-1">Specialties (Select up to 3)</label>
                  <button
                    type="button"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="instagram" className="block text-sm font-semibold text-gray-700 ml-1">Instagram Link</label>
                    <div className="relative group">
                      <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-orange-500 transition-colors">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="youtube" className="block text-sm font-semibold text-gray-700 ml-1">YouTube Link</label>
                    <div className="relative group">
                      <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-orange-500 transition-colors">
                ...
                <div className="flex items-start gap-3 py-2">
                  ...
                  <label htmlFor="termsAccepted" className="text-sm text-gray-600 leading-relaxed">
                    I agree to the <a href="#" className="text-orange-500 hover:underline font-semibold">Terms and Conditions</a> and <a href="#" className="text-orange-500 hover:underline font-semibold">Privacy Policy</a>
                  </label>
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-4 bg-orange-500 text-white rounded-2xl font-bold text-lg shadow-xl shadow-orange-200 hover:bg-orange-600 hover:-translate-y-1 transition-all active:scale-95 disabled:opacity-50 disabled:translate-y-0"
                >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button type="button" className="flex items-center justify-center py-3 border border-gray-200 rounded-2xl hover:bg-gray-50 transition-colors font-semibold text-gray-700 gap-2">
